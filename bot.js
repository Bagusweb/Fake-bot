...
const botSay = (data) => {
  return [
    "Perkenalkan nama saya Bagus bot. siapa nama kamu?",
...
function finishing() {
  pertanyaan.innerHTML = `Thank u ya ${usersData[0]} udah main ke bagus bot 😉, kali-kali kita main ${usersData[2]} bareng ya!`;
